      ...
      >
        ...
        <div className="flex flex-col w-full max-w-xs">
          ...
          <div className="flex justify-between items-center gap-2 ">
            <button className="bg-indigo-500 text-lg text-white rounded h-10 w-10 " name="quantity" onClick={()=>dispatch({type:"DECREASE",payload:1})}>
              -
            </button>
            <div className="border flex-1 flex justify-center items-center h-10 rounded-md border-gray-300">
              <span className="text-lg" name="quantity" onBlur={(e)=>dispatch({type:"INCREASE",payload:{name:e.target.name, value:e.target.value}})}>0</span>
            </div>
            <button className="bg-indigo-500 text-lg text-white rounded h-10 w-10" name="quantity" onClick={()=>dispatch({type:"INCREASE",payload:1})}>
              +
            </button>
          </div>
        </div>
        <div className="flex flex-col w-full max-w-xs">
          ...
          <textarea name="feedback" id="feedback" cols="30" rows="4"
            onBlur={(e) =>
              dispatch({
                type: "INPUT",
                payload: { name: e.target.name, value: e.target.value },
